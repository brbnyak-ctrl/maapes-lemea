    ...
    <section id="hero" className="hero">
      <div className="container hero-grid">
        ...
        <div className="hero-content reveal">
          ...
          <h1>
            מחשבון שמלחיץ – <br />
            <span className="accent">לביטחון שמנצח.</span>
          </h1>

          <p className="hero-sub">
            שיעורים פרטיים בחשבון ומתמטיקה לתלמידי יסודי וחטיבת ביניים (כיתות
            א'-ט'). אנחנו לא משננים נוסחאות – אנחנו בונים בסיס חזק, סוגרים פערים
            מהכיתה ומחזירים לילד את החיוך ואת האמונה שהוא מסוגל.
          </p>
